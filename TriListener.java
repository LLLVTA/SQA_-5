    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(brnstr == "判断形状"){
            ...
            if(!flag) {
                ...
                //判断输入参数是否在范围内
                int maxYear = 200, minYear = 1;
                if(ila > maxYear || ila < minYear || ilb > maxYear || ilb < minYear || ilc > maxYear || ilc < minYear) {
                    ...
                    if(ila + ilb <= ilc || ila +ilc <= ilb || ilb + ilc <= ila){
                        ...
                        if(ila == ilb && ila == ilc) {
                            Triangle.xoutput.setText("等边三角形");
                        } else if(ila == ilb || ila == ilc || ilb == ilc) {
                            Triangle.xoutput.setText("等腰三角形");
                        } else {
                            Triangle.xoutput.setText("一般三角形");
                        }
                    }
                }
            }
